...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="shadow-input relative flex items-center justify-center space-x-4 rounded-lg border-transparent bg-neutral-200 px-8 py-6 shadow-sm"
    >
      {children}
    </nav>
  );
...
export const HoveredLink = ({ children, ...rest }: any) => {
  return (
    <Link
      {...rest}
      className="text-neutral-700 transition duration-200 hover:bg-neutral-200 hover:text-black"
    >
      {children}
    </Link>
  );

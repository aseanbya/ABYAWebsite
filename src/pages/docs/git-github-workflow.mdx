...
-   The `main` branch is the branch that is deployed to production and visible to the public at [lfg.travel](https://lfg.travel).
...
-   The `dev` branch is the development branch of the repository. This is the branch that is deployed to the staging environment
    at [lfg-git-dev-lfgtravel.vercel.app/](https://lfg-git-dev-lfgtravel.vercel.app/).

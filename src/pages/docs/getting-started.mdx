...
-   a [**GitHub**](https://github.com) account with read and write permissions to the [ABYA codebase](https://github.com/ASEANBusinessYouthAssociation/ABYA).
...
```
git clone https://github.com/ASEANBusinessYouthAssociation.git
```

3. Navigate to the newly created folder containing the ABYA codebase.
...
5. Start the development server, then navigate to [`http://localhost:3000`](http://localhost:3000) in your browser.
   You should see the ABYA landing page.
